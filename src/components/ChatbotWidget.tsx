...
const faqBank: { keywords: string[]; q: string; a: string }[] = [
  // GENERAL
  { keywords: ["what is presciaiq", "presciaiq", "who are you", "about presciaiq", "what do you do"], q: "What is PresciaIQ?", a: "PresciaIQ is Australia's AI Intelligence & Development Company. We design and build AI platforms for Australian businesses that need more than off-the-shelf can deliver. We're based in Sydney, NSW, with a presence in Miami, FL." },
