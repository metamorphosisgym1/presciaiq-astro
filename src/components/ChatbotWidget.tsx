...
const faqBank: { keywords: string[]; q: string; a: string }[] = [
  ...
  { keywords: ["buildpredictiq price", "buildpredictiq cost", "report cost", "$2500", "construction pricing"], q: "How much does a BuildPredictIQ report cost?", a: "A single Pay-As-You-Go report costs **$2,500**. The Professional plan is **$4,999/year** (20 reports, API access, benchmarking). Enterprise plans with unlimited reporting are available on custom pricing." },
